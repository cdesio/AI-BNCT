...
namespace
{
const G4String kDefaultSugarFile = "../geometryFiles/sugarPos_n2_300nm_H75nm_R11nm_33hist_50deg.bin";
const G4String kDefaultHistoneFile = "../geometryFiles/histonePos_n2_300nm_H75nm_R11nm_33hist_50deg.bin";
}
...
int main(int argc, char **argv)
{
  ...
  if (((commandLine = GetPhaseSpaceInputCommand(parser))) || ((commandLine = parser->GetCommandIfActive("-photonPS"))))
  {
    ...
    if ((commandLine = GetPhaseSpaceInputCommand(parser)))
    {
