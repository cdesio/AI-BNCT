    ...
    , fChemistryList_option3(nullptr)
{
    ...
    SetVerboseLevel(0);
  if(IsPhaseSpaceInputActive(CommandLineParser::GetParser()))
{
    RegisterConstructor("G4EmDNAPhysics_option2_Jinyan");
}
...
void PhysicsList::RegisterConstructor(const G4String& name)
{
    ...
    else if(name == "G4EmDNAPhysics_option2_Jinyan")
    {
        fDNAPhysicsList.reset(new G4EmDNAPhysics_option2_Jinyan(verboseLevel));
        fPhysDNAName = name;
    } 
